...
A small MCTS framework in Python. You can play tic-tac-toe, Connect Four, Checkers (6×6), Dots and Boxes, or watch 2048; there’s a Flat UCB variant to compare against standard UCT, tree visualization, and a benchmark script that pits MCTS against a random player.
